...
\vspace{-0.25in}
\begin{outerlist}
\item {Introduction to Macroeconomics (ECO 1002)} --- \textit{Teaching Assistant} \hfill Spring 2026--Spring 2027 \\
    Zicklin School of Business, Baruch College, CUNY. \\
    \textit{Hybrid course experiment with Babak Somekh, Konstantin Kucheryavyy, and Ted Joyce.} \\
