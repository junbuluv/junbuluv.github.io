...
\begin{outerlist}
  \item \textbf{2026}
    \begin{innerlist}
      ...
      \vspace{1mm}
      \item FIRS Conference Ph.D. Student Sessions
      \vspace{1mm}
...
\vspace{-0.25in}
\begin{outerlist}
\item {Introduction to Macroeconomics (ECO 1002)} \hfill Spring 2026, Fall 2026, Spring 2027 \\
    Zicklin School of Business, Baruch College, CUNY. \\
    \textit{Hybrid course experiment with Babak Somekh, Konstantin Kucheryavyy, and Ted Joyce (Baruch College Fund / Zicklin Fund \#79540).} \\
