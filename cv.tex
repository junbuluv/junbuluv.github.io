...
\begin{outerlist}
    ...
    \item Rules, Discretion, and Soft Information in Small Business Lending (with Linda Allen and Fabrice Tourre) \hfill \textit{Work in Progress}
\end{outerlist}
...
\begin{outerlist}
  \item \textbf{2026}
    \begin{innerlist}
      \item European Finance Association Annual Meeting --- Doctoral Tutorial, Ghent (Scheduled, August 2026)
      \vspace{1mm}
